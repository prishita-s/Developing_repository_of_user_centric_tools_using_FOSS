	...
	<style>
		...
		* {
		...
		body {
			...
			background-image: url(../Images/Website/buyerLogin.jpg);
					...
					<div class="card " >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"  class="text-left"><a id='link' style="background-color:#292b2c;color:black" href="FarmerForgotPassword.php"><b style="color:black ;text-align:left"> Forgot your password </b></a></label>
									<br>
