    ...
    margin-left:10px;
        ...
        * {
        ...
        body {
            margin: 0;
            font-family: Arial;
            background-image: url(../Images/Website/buyer.jpg);
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="../Images/Website/logo.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        <button class="navbar-toggler" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"><i class="fas fa-bars p-1 " style="color:green;margin-right:-10%;font-size:28px;"></i></span>
        </button>
        <a class="float-left" href="bhome.php">
            <img src="../Images/Website/logo.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
    ...
    <div class="container"> <img src="../Images/Website/organic.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
        ...
        <div class="container">
            <div class="row text-center text-xs-center text-sm-left text-md-left">
                <div class="col aligncenter">
                    ...
                    <img src="../Images/Website/cod.png" alt="paytm" style="height:37px">
                </div>
            </div>
        </div>
    </section>
