...
<br>
        <b>
            <h1 class="guard"><span><b>MY PROFILE</b></span>
            </h1>
        </b>
        <br>
    </div></div>
    ...
    <div class="container" >
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#000000;color:goldenrod">Edit Profile</button>
    </div>
</body>
