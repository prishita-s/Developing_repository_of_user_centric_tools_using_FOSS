      ...
      <body>
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="../Images/Website/logo.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:100px;">
                     </a>
                </div>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                         ...
                         <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/fruitbasket.jpg" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/farm1.jpg" alt="Third slide">
                          </div>
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/handshake.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
