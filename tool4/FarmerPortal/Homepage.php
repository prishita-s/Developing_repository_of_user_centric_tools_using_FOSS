...
<body>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                    <div class="carousel-item active">
                         <img class="image1" src="../Images/Website/images.jpg" height="500px" width="1350px" alt="...">
                         <div class="time"></div>
                    </div>
                    <div class="carousel-item">
                         <img class="image1" src="../Images/Website/farm1.jpg" height="500px" width="1350px" alt="...">
                    </div>
               </div>
          </div>
     </div>
     ...
     <div class="whatsnew">
          ...
          <div class="f2 f1">
               <div class="t1 t4">WIDE RANGE OF BUYERS
               </div>
          </div>
     ...
     <div class="footer">
          ...
          <div class="cash"><img src="../Images/Website/cash.jpg" height="75px" width="100px"></div>
          <div class="patym"><img src="../Images/Website/paytm1.jpg" height="50px" width="150px"></div>
     </div><br><br>
